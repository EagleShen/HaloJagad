...
using HaloJagad.API.Common.Attributes;
using HaloJagad.API.Common.Middlewares;
using HaloJagad.API.Common.Settings;
using HaloJagad.API.Swagger;
				...
				if (_appSettings.IsValid())
				{
					...
					if (_appSettings.Swagger.Enabled)
					{
						...
						services.AddSwaggerGen(options =>
						{
							...
							if (referencedAssemblies?.Any() == true)
