...
namespace HaloJagad.API.Controllers.V1
{
	[ApiVersion("1.0")]
...
#pragma warning restore CS1591
		...
		public async Task<User> CreateUser([FromBody] UserCreationRequest value)
		{
			...
			var data = await _service.CreateAsync(_mapper.Map<S.User>(value.User)).ConfigureAwait(false);
		...
		public async Task<bool> UpdateUser(User parameter)
		{
			...
			return await _service.UpdateAsync(_mapper.Map<S.User>(parameter)).ConfigureAwait(false);
		}
		#endregion
